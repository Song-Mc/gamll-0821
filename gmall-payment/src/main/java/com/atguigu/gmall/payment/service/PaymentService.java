 ...
 * package: com.atguigu.gmallpayment.service
 * version : 1.0
 * Description
 */
@Service
public class PaymentService {
    ...
    public OrderEntity queryOrderByToken(String orderToken) {
        ...
        ResponseVo<OrderEntity> queryOrderByToken = this.omsClient.queryOrderByToken(orderToken);
        return queryOrderByToken.getData();
    }
